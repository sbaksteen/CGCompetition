...
class OBJLoader
{
    ...
    public:
         ...
         *
         */
        std::vector<Vertex> unitize(std::vector<Vertex> verts);
		std::vector<Vertex> scale(double factor, std::vector<Vertex> verts);
		std::vector<Vertex> translate(Vector translation, std::vector<Vertex> verts);
